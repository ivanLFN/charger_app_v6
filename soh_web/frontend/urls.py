...
from frontend.views import partner_detail, store, product_detail, personal_data, create_order_or_question, success_send, partnership_page, contacts


urlpatterns = [
    path('', main_app, name='main_page'),
    ...
    path('partnership_page/', partnership_page, name='partnership_page'),
